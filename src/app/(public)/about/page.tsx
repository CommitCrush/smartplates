...
export default function AboutPage() {
  ...
  const features = [
    {
      ...
      description:
        "AI-powered recommendations based on your preferences, dietary restrictions, and available ingredients.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Weekly meal planning with drag-and-drop calendar, portion control, and automatic grocery list generation.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Analyze your fridge contents with AI to get recipe suggestions and reduce food waste.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Your meal preferences and data are protected with enterprise-grade security measures.",
      benefits: [
        "Data encryption",
        "Privacy controls",
  ...
  const milestones = [
    {
      year: "2023",
      event: "SmartPlates founded with a vision to revolutionize meal planning",
    },
    ...
    {
      year: "2024",
      event: "Partnership with major grocery chains for ingredient delivery",
    },
  ];
      ...
      <section className="pt-20 sm:pt-32 md:pt-40 lg:pt-52 pb-10 sm:pb-12 md:pb-16 lg:pb-20 min-h-[80vh] bg-background flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-foreground-muted max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed">
            ...
            enjoyable, and effortless for everyone. Through AI-powered meal
            planning and intelligent recipe recommendations, we help you
            discover the joy of cooking while saving time and reducing food
            waste.
          </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-foreground mb-2 group-hover:text-primary-600 transition-colors duration-300">
                  {stat.value}
                </div>
            ...
            <div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2 group-hover:text-primary-600 transition-colors duration-300">
                      Promote Healthy Living
                    </h3>
                    <p className="text-foreground-muted">
                      Make nutritious meal planning accessible to everyone,
                      regardless of cooking experience or time constraints.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2 group-hover:text-coral-600 transition-colors duration-300">
                      Reduce Food Waste
                    </h3>
                    <p className="text-foreground-muted">
                      Help families minimize food waste through smart planning
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-muted">
                      Create a global community of food enthusiasts sharing
                      recipes, tips, and culinary discoveries.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary-600 dark:bg-primary-700 rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105">
                <div className="relative">
                  ...
                  <blockquote className="text-base sm:text-lg italic mb-4">
                    &ldquo;We believe that everyone deserves access to healthy,
                    delicious meals without the stress of planning and
                    preparation. Technology should make cooking more enjoyable,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
              Our platform combines cutting-edge AI technology with nutritional
              science to deliver a meal planning experience that&apos;s both
              ...
              >
                ...
                <CardHeader className="relative">
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-lg sm:text-xl text-foreground group-hover:text-primary-600 transition-colors duration-300">
                      {feature.title}
                    </CardTitle>
                  </div>
                </CardHeader>
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, idx) => (
                      ...
                      >
                        ...
                        <span className="text-foreground-muted group-hover/item:text-foreground transition-colors duration-200">
                          {benefit}
                        </span>
                      </li>
                    ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
              ...
              and nutrition experts working together to transform how people
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground-muted leading-relaxed">
              From a simple idea to a platform serving thousands of users
              worldwide.
            </p>
          </div>
                ...
                <div key={index} className="relative flex items-center group">
                  ...
                  <div className="flex-1 ml-6 sm:ml-8">
                    <div className="bg-card border border-border p-4 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 group-hover:scale-105 group-hover:-translate-y-1">
                      ...
                      <p className="text-foreground relative group-hover:text-primary-600 transition-colors duration-300">
                        {milestone.event}
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-background-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground-muted mb-6 sm:mb-8 leading-relaxed">
            Ready to transform your relationship with food? Join thousands of
            users who have already discovered the joy of stress-free meal
            planning.
          </p>
