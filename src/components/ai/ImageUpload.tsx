    ...
    <div className="flex flex-col items-center gap-4 w-full">
      {!image ? (
        <>
          ...
          <button
            className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl border-2  bg-white text-primary font-semibold  hover:text-red-400 transition"
