        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-foreground">SmartPlates</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/recipe" 
                  className="text-foreground-secondary hover:text-primary-600 hover:bg-neutral-100 dark:hover:bg-neutral-800 block px-2 py-1 rounded-md transition-colors"
                >
                  Browse Recipes
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-foreground-secondary">AI Recipe Suggestions</span>
              </li>
              <li>
                <span className="text-foreground-secondary">Meal Planning</span>
              </li>
              <li>
                <span className="text-foreground-secondary">Grocery Lists</span>
              </li>
              <li>
                <span className="text-foreground-secondary">Recipe Collections</span>
              </li>
              <li>
                <span className="text-foreground-secondary">Cookware Recommendations</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-foreground-secondary">hello@smartplates.com</span>
              </div>
              <div className="flex items-center space-x-3">
            ...
            {/* Newsletter Signup Placeholder */}
            <div className="mt-6">
              <h4 className="text-sm font-semibold mb-2 text-foreground">Stay Updated</h4>
        ...
        <div className="border-t border-border py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link 
                href="/privacy" 
                className="text-foreground-secondary hover:text-primary-600 hover:bg-neutral-100 dark:hover:bg-neutral-800 px-2 py-1 rounded-md transition-colors text-sm"
              >
                Privacy Policy
              </Link>
              <Link 
